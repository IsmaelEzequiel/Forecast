defmodule WeatherEdge.Signals.Alerter do
  ...
  """
  @spec broadcast_signals(String.t(), [map()], Date.t() | nil, String.t() | nil) :: :ok
  def broadcast_signals(station_code, signals, target_date \\ nil, event_slug \\ nil)
      when is_binary(station_code) do
