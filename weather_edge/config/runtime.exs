...
#
#     PHX_SERVER=true bin/weather_edge start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :weather_edge, WeatherEdgeWeb.Endpoint, server: true
end

# Polymarket API credentials (available in all environments)
config :weather_edge, :polymarket,
...
if config_env() == :prod do
  ...
  config :weather_edge, WeatherEdge.Repo,
    # ssl: true,
    url: database_url,
  ...
  config :weather_edge, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
